                  ...
                  <div class="col-md-12">
                     ...
                     <div class="mail_section_1">
                        ...
                        <p style='color:red; text-align:center;'><?php if(isset($erreur)) echo $erreur; ?></p>
                           <div class="row">
                              <div class="col-md-12">
                                 <input type="text" class="mail_text" placeholder="nom" value="John Doe" name="nom">
                              </div>
                              
                         <div class="col-md-12">
                           <input type="password" class="mail_text" placeholder="mot de passe" value="motdepasse123" name="mdp">
                        </div>
